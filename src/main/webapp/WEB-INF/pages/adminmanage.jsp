...
<div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="adminprofile"><i class="fa fa-dashboard "></i>Profile</a>
                    </li>
                    <li>
 ...
 <tr><th>Name</th><th>Email</th><th>Contact</th><th>password</th><th>Profession</th><th>Address</th><th>City</th> <th>Country</th><th>Status</th><th colspan=2>Action</th></tr> 
 <%
 ...
 while(i.hasNext())
 {
	 ...
	 uname=aa.getUname();
	 email=aa.getUemail();
	 ucontact=aa.getUcontact();
	 password=aa.getUpassword();
	 uprofession=aa.getUprofession();
	 uaddress=aa.getUaddress();
	 ucity=aa.getUcity();
	 ucountry=aa.getUcountry();
	 cstatus=aa.getStatus();
	...
	//out.println(uname);
	 ...
	 <td><% out.println(ucity); %></td>
	  <td><% out.println(ucountry); %></td>
	  <td><% out.println(cstatus); %></td>
	  <td>
	  <form action="AdminManageRecord" method="post">
	  <select name="manage">
