...
<div id="wrapper">
 ...
 <tr><th>Name</th><th>Email</th><th>Contact</th><th>password</th><th>Profession</th><th>Address</th><th>City</th> <th>country</th></tr> 
 <%
 ...
 Query q=s.createQuery("from User where uname like'"+sname+"%'");
 List l=q.list();
