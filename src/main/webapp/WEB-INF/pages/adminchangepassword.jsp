...
<div id="wrapper">
 ...
 -->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="adminchangepassword"><i class="fa fa-flash "></i>change password </a>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h1 style="text-align:center">To change the Password</h1>
  <form action="AdminChangePassword" method="post" >
 <center><table border='1'>
 <tr>
 <th>Current Password</th>
 <td><input type="text" placeholder="current password" name="upassword"></td>
 </tr>
 <tr>
 <th>New Password</th>
 ...
 <td><input type="text" placeholder="confirm password" name="confirmpassw"></td>
 </tr>
 <tr>
                   <th colspan="2">
