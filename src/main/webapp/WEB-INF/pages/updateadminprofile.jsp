        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="updateadminprofile"><i class="fa fa-dashboard "></i>Update Profile</a>
                    </li>
                    <li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="useraccount"><i class="fa fa-bicycle "></i>Create Account <span class="fa arrow"></span></a>
                         <!-- <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    ...
                    Query q=s.createQuery("from User where uemail='"+uemail+"'");
                    List l=q.list();
                    ...
                    while(i.hasNext())
                    {
                    	User u=(User)i.next();
                    	name=u.getUname();
                    	ucontact=u.getUcontact();
                    	upassword=u.getUpassword();
                    	uprofession=u.getUprofession();
                    	uaddress=u.getUaddress();
                    	ucity=u.getUcity();
                    	ucountry=u.getUcountry();
                    	role=u.getRole();
                    	status=u.getStatus();
                    ...
                    <form action="updateadminprofileresult" method="post" modelAttribute="adminupdate">
                   <center><table border="1">
                     
                    <tr>
                    <th>Name</th>
                    <td><input type="text" name="uname" value="<% out.print(name); %>"/></td>
                    </tr>
                    <tr>
                    <th>Email</th>
                    <td><input type="text" name="uemail" value="<% out.print(uemail); %>"/></td>
                    </tr>
                    <tr>
                    <th>Contact</th>
                    <td><input type="text" name="ucontact" value="<% out.print(ucontact); %>"/></td>
                    </tr>
                    <tr>
                    <th>Password</th>
                    <td><input type="text" name="upassword" value="<% out.print(upassword); %>"/></td>
                    </tr>
                    <tr>
                    <th>Profession</th>
                    <td><input type="text" name="uprofession" value="<% out.print(uprofession); %>"/></td>
                    </tr>
                    <tr>
                    <th>Address</th>
                    <td><input type="text" name="uaddress" value="<% out.print(uaddress); %>"/></td>
                    </tr>
                    <tr>
                    <th>City</th>
                    <td><input type="text" name="ucity" value="<% out.print(ucity); %>"/></td>
                    </tr>
                    <tr>
                    <th>Country</th>
                    <td><input type="text" name="ucountry" value="<% out.print(ucountry); %>"/></td>
                    </tr>
                    <tr>
                   <th colspan="2">
                     ...
                     <button input type="submit" class="btn btn-primary ">Update</button>
                     </div>
                     </th>
                     </tr>
