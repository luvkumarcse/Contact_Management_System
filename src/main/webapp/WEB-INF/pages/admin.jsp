...
<div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <%
           String name="";
           String uemail=request.getAttribute("uemail").toString();
           // out.print(uemail); 
          ...
          Configuration con=new Configuration().configure().addAnnotatedClass(User.class);
       	...
       	Query query=sess.createQuery("from User where uemail='"+uemail+"'");
       	List lst=query.list();
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="updateadminprofile"><i class="fa fa-dashboard "></i>Profile Update</a>
                    </li>
                    
                    <li>
                        <!-- <a href="addcontact"><i class="fa fa-desktop "></i>Add Contact <span class="fa arrow"></span></a> -->
                     ...
                     <li>
                        <a href="useraccount"><i class="fa fa-bicycle "></i>Create Account <span class="fa arrow"></span></a>
                         <!-- <ul class="nav nav-second-level">
                             ...
                             <li>
                                <a href="changepassword"><i class="fa fa-desktop "></i>Change Password </a>
                            </li>
                             <li>
                                <a href="userlogout"><i class="fa fa-code "></i>Logout</a>
                            </li>
                      ...
                      <li>
                        <a href="adminmanage"><i class="fa fa-anchor ">Manage Account</i></a>
                    </li>
                    <li>
                        <a href="searchuser"><i class="fa fa-anchor ">Search User</i></a>
                    </li>
                    <li>
                        <a href=""><i class="fa fa-anchor ">Logout</i></a>
                    </li>
                     <!-- <li>
