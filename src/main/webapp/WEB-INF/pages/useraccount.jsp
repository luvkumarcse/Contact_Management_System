...
<div id="wrapper">
       ...
       //	String x="from User where uemail='"+uemail+"'";
       	//out.println(x);
 ...
 -->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="adminprofile"><i class="fa fa-dashboard "></i>Profile</a>
                    </li>
                    <li>
                        <a  href="updateadminprofile"><i class="fa fa-dashboard "></i>Update Profile</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="adminchangepassword"><i class="fa fa-flash "></i>Change password </a>
                        
                    </li>
                     <li>
                        <a class="active-menu" href="useraccount"><i class="fa fa-bicycle "></i>Create Account <span class="fa arrow"></span></a>
                         <!-- <ul class="nav nav-second-level">
                      ...
                      <li>
                        <a href="adminmanage"><i class="fa fa-anchor "></i>Account Manage</a>
                    </li>
                    <li>
                        <a  href="searchuser"><i class="fa fa-anchor "></i>Search User</a>
                    </li>
                    <li>
                        <a href="userlogout"><i class="fa fa-anchor "></i>Logout</a>
                    </li>
                     <!-- <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <form:form role="form" action="useraccountresult" method="post" modelAttribute="useraccount">
                                    <hr />
                                    <h4>Enter Details to Register</h4>
                                       ...
                                       <div class="form-group input-group">
                                            ...
                                            <form:input path="uname" id="name" class="form-control" placeholder="Enter the Name " />
                                        </div>
                                       </td>
                                        <td>
                                       ...
                                       <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                            <form:input path="uemail" id="email" class="form-control" placeholder="Enter the Email " />
                                        </div>
                                       </td>
                                       </tr>
                                       ...
                                       <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                            <form:input path="ucontact" id="contact" class="form-control" placeholder="Enter the Contact " />
                                        </div>
                                       </td>
                                        <td>
                                       ...
                                       <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                            <form:input path="upassword" id="password" class="form-control" placeholder="Enter the Password " />
                                        </div>
                                       </td>
                                       </tr>
                                       ...
                                       <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                            <form:input path="uprofession" id="profession" class="form-control" placeholder="Enter the Profession " />
                                        </div>
                                       </td>
                                        <td>
                                       ...
                                       <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                            <form:input path="uaddress" id="address" class="form-control" placeholder="Enter the Address " />
                                        </div>
                                       </td>
                                       </tr>
                                       ...
                                       <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                            <form:input path="ucity" id="city" class="form-control" placeholder="Enter the City " />
                                        </div>
                                       </td>
                                        <td>
                                       ...
                                       <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                            <form:input path="ucountry" id="country" class="form-control" placeholder="Enter the Country " />
                                        </div>
                                       </td>
                                       </tr>
                                       
                                       </table>
                                    <form:button id="btn" class="btn btn-primary ">Register</form:button>
