 ...
 -->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="addcontact"><i class="fa fa-dashboard "></i>AddContact</a>
                    </li>
                    <li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="completerecord"><i class="fa fa-bicycle "></i>Complete Record <span class="fa arrow"></span></a>
                         <!-- <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-8">
                    <h1 style="text-align:center">User to add contact</h1>
                    <form:form action="addcontactform" method="post" modelAttribute="addcontact">
                    ...
                    <tr>
                    <th>Email</th>
                    <td><form:input path="email" placeholder="Enter the email"/></td>
                    </tr>
                    
                    <tr>
                    <th>Contact</th>
                    <td><form:input path="contact" placeholder="Enter the contact"/></td>
                    </tr>
                    <tr>
                    <th>Profession</th>
                    <td><form:input path="profession" placeholder="Enter the profession"/></td>
                    </tr>
                    <tr>
                    <th>Organization</th>
                    <td><form:input path="organisation" placeholder="Enter the orgnisation"/></td>
                    </tr>
                    <tr>
                    <th>Address</th>
                    <td><form:input path="address" placeholder="Enter the address"/></td>
                    </tr>
                    <tr>
                    <th>City</th>
                    <td><form:input path="city" placeholder="Enter the city"/></td>
                    </tr>
                   ...
                   <th colspan="2">
                     ...
                     <input type="hidden"  name="uemail" value ="<% out.print(uemail); %>" />
