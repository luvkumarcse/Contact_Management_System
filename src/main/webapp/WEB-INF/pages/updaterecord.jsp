        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                  ...
                  Query q= s.createQuery("from AddContact where id='"+uid+"'");
                  List l=q.list();
                  ...
                  while(i.hasNext())
                  {
                	  AddContact a=(AddContact)i.next();
                	  uname=a.getName();
                	  email=a.getEmail();
                	  contact=a.getContact();
                	  profession=a.getProfession();
                	  organisation=a.getOrganisation();
                  ...
                  t.commit();
                   ...
                   %>
                   <form action="updaterecordform" method="post" modelAttribute="updaterecord">
                  <center> <table border="1">
                  <input type="hidden" name="id" value="<% out.print(uid); %>"/>  
                   <tr>
                   <th>Name</th>
                   <td><input type="text" name="name" value="<% out.print(uname); %>"/></td>
                   ...
                   <tr>
                   <th>Contact</th>
                   <td><input type="text" name="contact" value="<% out.print(contact); %>"/></td>
                   </tr>
                   <tr>
                   <th>Profession</th>
                  <td><input type="text" name="profession" value="<% out.print(profession); %>"/></td>
                   </tr>
                   <tr>
                   <th>Organization</th>
                   <td><input type="text" name="organisation" value="<% out.print(organisation); %>"/></td>
                   </tr>
                   <tr>
                   <th>Address</th>
